...
/**
 * Servlet implementation class areaCircunferencia
 */
...
public class areaCircunferencia extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("raio")!=null) {
			raio = Integer.parseInt(request.getParameter("raio"));
			area = raio*3*raio; //estamos trabalhando com inteiro 
		}
		
		strURL = "/resultado_area.jsp?TipoFigura=3&ValorArea="+area;
